...
- 不要新增医学事实；只能围绕 base_hint、pedagogy_state、skill_context 和已公开对话做教学引导。
...
class DeterministicCoachAgent:
    def __call__(self, request: CoachRequest) -> CoachResponse:
        return CoachResponse(hint=sanitize_coach_hint(request.base_hint, request.forbidden_terms))
